...
id: M-0012
type: map
title: Карта проекта без узлов-каталогов
status: review
created: 2026-09-12
updated: 2026-09-12
links:
...
# Карта проекта без узлов-каталогов

Та же сводная карта, что M-0009, без девяти узлов-каталогов (`data/local`,
`data/repository`, `ui/session` и других) и 28 связей к ним. Прежние карты
описывали пакет целиком; сборка M-0009 снимала такие узлы по короткому имени,
а эти были записаны полным путём и прошли мимо. Задача — T-0015.
...
Пока карта не подтверждена, действует M-0009, и общая картина не пустеет.
После подтверждения M-0009 помечается заменённой.
