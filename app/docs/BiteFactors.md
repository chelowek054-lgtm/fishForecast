...
| Норма давления водоёма | Точка отсчёта, без неё цифра бессмысленна | ✅ среднее за 70 суток наблюдений; без сети — по высоте места | ✅ `baselinePressureMmHg`, ручная старше | ✅ пунктир на графике и её происхождение | ✅ |
...
в том же ответе: 746.4 мм — разница в пределах округления. Ручной ввод
остался и старше расчёта: рыболов может знать про свой пруд то, чего не
знает модель.
...
мг/л, история собственного барометра, автоматическая норма давления.
