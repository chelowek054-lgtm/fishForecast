...
**Наблюдения по-прежнему не применяются** — это следующая работа.
...
потом менять предположения модели. Первый пункт закрыт, следующий — наблюдения:
данные и словарь на месте, не хватает применения.
