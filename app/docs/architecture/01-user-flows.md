...
Район переключается из шапки любого раздела — строкой под названием экрана.
Стрелка стоит там всегда, даже когда район один: скрытая, она выглядела так,
будто переключателя нет вовсе, — а с единственным районом он нужнее всего,
потому что из того же меню заводят второй («Все карты»).
Раньше за этим приходилось уходить в «Сохранённые карты», хотя вопрос «а что
на другом пруду» возникает ровно там, где смотришь погоду или клёв. Смена
района не требует сети: прогноз, зори и точки уже лежат в базе по каждой
карте и подставляются сразу; сеть нужна только чтобы их обновить.
